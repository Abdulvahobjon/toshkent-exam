          ...
          <div className="hover:shadow-sm pb-5 w-[302px] ml-auto">
            ...
            <div className="flex items-center justify-between mb-[2px]">
              ...
              <span className="flex gap-1 items-center text-[#222] leading-5">
                ...
                <span>{data ? data.id : data1[id].id}</span>
              </span>
            </div>
            <p className="text-[#717171] leading-5 text-base">
            {data ? data.category : data1[id].category}
            </p>
            <p className="text-[#717171] leading-5 text-sm mb-2">  {data ? data.num : data1[id].num}</p>
            <p className="text-[#222] text-base leading-5 flex gap-1 items-center">
              <b className="font-bold">{data ? data.price : data1[id].price}</b>night
            </p>
          </div>
        </div>
      </section>
